    ...
    <section id="hero">
      <div className="hero-container">
        <div className="hero-text-container" data-aos="fade-up">
          ...
          <p>A 3rd Year Student In Software Engineering.</p>
        </div>
      ...
      <div className="about-container" data-aos="fade-up">
        <div className="about-card">
          <section className="about-content">
            <h2> About</h2>
            <p>I currently a 3rd Year Student in University of the South Pacific pursuing a degree in Bachelor of Software Engineering.</p>
            <p>I am also a front-end developer intern at Y company.</p>
            <p>I love a, b, and c things.</p>
          </section>
          ...
          <section className="about-content tech-stack-section">
            ...
            <div className="tech-stack-grid">
              ...
              <div className="tech-stack">
                <img src="./assets/icons/css.svg" alt="html5-icon" />
              </div>
              <div className="tech-stack">
                <img src="./assets/icons/javascript.svg" alt="html5-icon" />
              </div>
              <div className="tech-stack">
