...
import { SiReact, SiJava, SiHtml5, SiJavascript, SiTypescript, SiCplusplus, SiPython } from 'react-icons/si';
  ...
  return (
    <section id="about">
      ...
      <div className="tech-stack">
        <SiReact className="about-icon react-icon" />
      </div>
      <div className="tech-stack">
        <SiJava className="about-icon java-icon" />
      </div>
      <div className="tech-stack">
        <SiHtml5 className="about-icon html-icon" />
      </div>
      <div className="tech-stack">
        <SiJavascript className="about-icon js-icon" />
      </div>
      <div className="tech-stack">
      ...
      <div className="tech-stack">
        <SiPython className="about-icon python-icon" />
      </div>
    </div>
          </section>
        </div>
